...
Forward::Forward(int player_id, int team_id, map<int, field_grid> *fm, map<int, int> *player_pos){
...
Forward::Forward(int player_id, int team_id, int x_pos, int y_pos, map<int, field_grid> *fm, map<int, int> *player_pos){
...
int Forward::discretize_position(){
	return 5*y + x;
}


void Forward::take_off_ball_action(){
...
int Forward::take_on_ball_action(){
